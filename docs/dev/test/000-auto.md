...
## container  
  - [ ] Тесты работы с [контейнерами][22].  
    - [ ] `std::vector<int>`  
    - [ ] `std::vector<users>`  
  ...
  - [ ] Номинации:  
    ...
    - [ ] От базы пришла одна строка.  
      - [ ] Количество полей приёмника равно количеству столбцов в ответе.  
      - [ ] Количество полей приёмника больше, чем столбцов в ответе.  
      - [ ] Количество полей приёмника меньше, чем столбцов в ответе.  
