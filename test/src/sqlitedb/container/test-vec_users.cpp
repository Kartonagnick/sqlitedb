...
static const char* base = "00-vec_users.db";

namespace test_vec_users
{
    struct normal
    {
        size_t login;
...
namespace test = test_vec_users;
using normal_t = std::vector<test::normal>;
using small_t  = std::vector<test::small>;
using big_t    = std::vector<test::big>;
